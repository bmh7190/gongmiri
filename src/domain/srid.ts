...
const SRID_UNSORTED: SridOption[] = [
  ...
  },
  {
    ...
    proj4: "+proj=merc +a=6378137 +b=6378137 +lat_ts=0 +lon_0=0 +x_0=0 +y_0=0 +k=1 +units=m +nadgrids=@null +no_defs +type=crs",
  },
  {
    code: 5174,
    name: "EPSG:5174",
...
const SRID_PATTERNS: Record<SridCode, RegExp[]> = {
  ...
  5176: [/5176/, /east[_\s]?belt(?![_\s]?2010)/i],
};
